...
sprites.onCreated(SpriteKind.Food5, function (sprite) {
    sprite.setImage(img`
        . . . . . . . e c 7 . . . . . . 
        . . . . e e e c 7 7 e e . . . . 
...
sprites.onCreated(SpriteKind.Food4, function (sprite) {
    sprite.setImage(img`
        . . . . c c c b b b b b . . . . 
...
sprites.onDestroyed(SpriteKind.Food3, function (sprite) {
    pause(500)
...
sprites.onDestroyed(SpriteKind.Food4, function (sprite) {
    pause(500)
...
sprites.onDestroyed(SpriteKind.Food5, function (sprite) {
    pause(500)
...
sprites.onCreated(SpriteKind.Food3, function (sprite) {
    sprite.setImage(img`
        . . 2 2 b b b b b . . . . . . . 
        . 2 b 4 4 4 4 4 4 b . . . . . . 
